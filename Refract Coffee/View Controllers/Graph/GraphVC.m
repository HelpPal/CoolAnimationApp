...
- (void)viewDidLoad {
    ...
    if (self.isEdit ==  false) {
        [self.addeditButton setBackgroundImage:[UIImage imageNamed:@"add_icon"] forState:UIControlStateNormal];
    }
    else
    {
        [self.addeditButton setBackgroundImage:[UIImage imageNamed:@"edit_icon"] forState:UIControlStateNormal];
    }
    ...
    [self.customScroll setupDefaults];
}
...
- (IBAction)onPressKeyboard:(UIButton *)sender {
    switch (sender.tag) {
        case 0:
            inputStr = [inputStr stringByAppendingString:@"0"];
            break;
        case 1:
            inputStr = [inputStr stringByAppendingString:@"1"];
            break;
        case 2:
            inputStr = [inputStr stringByAppendingString:@"2"];
            break;
        case 3:
            inputStr = [inputStr stringByAppendingString:@"3"];
            break;
        case 4:
            inputStr = [inputStr stringByAppendingString:@"4"];
            break;
        case 5:
            inputStr = [inputStr stringByAppendingString:@"5"];
            break;
        case 6:
            inputStr = [inputStr stringByAppendingString:@"6"];
            break;
        case 7:
            inputStr = [inputStr stringByAppendingString:@"7"];
            break;
        case 8:
            inputStr = [inputStr stringByAppendingString:@"8"];
            break;
        case 9:
            inputStr = [inputStr stringByAppendingString:@"9"];
            break;
        case 10:
    ...
    [self.customScroll onTextInput:inputStr];
}
...
-(IBAction)addAction:(id)sender {
    ...
    nxtObj.coffeeDict = [[NSMutableDictionary alloc] initWithDictionary:@{NAME: name, TDS: @"1.25", DOSE: @"23.0", BW: [NSString stringWithFormat:@"%d", (int)ceilf(brewWater)], TYPE: self.type}];
    nxtObj.isEdit = self.isEdit;
    [self.navigationController pushViewController:nxtObj animated:true];
}
