...
@interface GraphVC : BaseVC <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, MFMailComposeViewControllerDelegate, UIGestureRecognizerDelegate, MFMailComposeViewControllerDelegate, iCoffeeDelegate>

@property (strong, nonatomic) UIView *myView;
@property (weak, nonatomic) IBOutlet UILabel *extractionLabel;
@property (weak, nonatomic) IBOutlet UIButton *addeditButton;
@property (nonatomic, strong) IBOutlet iCoffee *customScroll;
