...
- (void) customiseUI {
    ...
    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleDefault];//set status bar font color
...
- (IBAction)onProfileEdit:(UIButton *)sender
{
    UserEditVC *nxtObj = [self.storyboard instantiateViewControllerWithIdentifier:@"UserEditVC"];
    [self presentViewController:nxtObj animated:YES completion:NULL];
}
